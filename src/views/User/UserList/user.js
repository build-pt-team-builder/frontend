        ...
        {console.log(this.state.user)}
            ...
            <div className='info'>
                ...
                :   <>   
                        ...
                        <pre className='role'>{this.state.user.cohort}</pre>
                    </>
                }
            </div>
            <div className='info'>
                ...
                {this.state.editing
                    ...
                    :   <pre className='value'>{this.state.user.role}</pre>
                }
            </div>
            <div className='info'>
                ...
                {this.state.editing
                    ...
                    :   <pre className='value'>{this.state.user.project_manager}</pre>
                }
            </div>
            <div className='info'>
                ...
                {this.state.editing
                    ...
                    :   <pre className='value'>{this.state.user.project || 'None'}</pre>
                }
            </div>
